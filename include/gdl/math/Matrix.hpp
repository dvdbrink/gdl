#ifndef GDL_MATH_MATRIX_HPP
#define GDL_MATH_MATRIX_HPP
...
template<typename T, size_t N>
Matrix<T, 4, 4> lookAt(const Vector3<T>& position, const Vector3<T>& target, const Vector3<T>& up);

#include <gdl/math/Matrix.inl>
