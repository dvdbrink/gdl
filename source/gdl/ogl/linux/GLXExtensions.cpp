...
namespace glX
{
	...
	typedef Display * (CODEGEN_FUNCPTR *PFNGETCURRENTDISPLAYEXT)();
	...
	namespace sys
	{
		namespace 
		{
			...
			{
				table.reserve(12);
				table.push_back(MapEntry("GLX_ARB_create_context", &exts::var_ARB_create_context, Load_ARB_create_context));
				...
				table.push_back(MapEntry("GLX_EXT_import_context", &exts::var_EXT_import_context, Load_EXT_import_context));
				table.push_back(MapEntry("GLX_EXT_swap_control", &exts::var_EXT_swap_control, Load_EXT_swap_control));
